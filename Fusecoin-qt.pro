...
# define LEVELDB_ROOT to use custom leveldb
# LEVELDB_ROOT=C:/deps/leveldb
...
isEmpty(LEVELDB_ROOT): LEVELDB_ROOT = $$PWD/src/leveldb

INCLUDEPATH += $$LEVELDB_ROOT/include $$LEVELDB_ROOT/helpers
LIBS += $$LEVELDB_ROOT/libleveldb.a $$LEVELDB_ROOT/libmemenv.a
...
!win32 {
    ...
    genleveldb.commands = cd $$LEVELDB_ROOT && CC=$$QMAKE_CC CXX=$$QMAKE_CXX $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" libleveldb.a libmemenv.a
} else {
...
genleveldb.target = $$LEVELDB_ROOT/libleveldb.a
genleveldb.depends = FORCE
PRE_TARGETDEPS += $$LEVELDB_ROOT/libleveldb.a
QMAKE_EXTRA_TARGETS += genleveldb
# Gross ugly hack that depends on qmake internals, unfortunately there is no other way to do it.
QMAKE_CLEAN += $$LEVELDB_ROOT/libleveldb.a; cd $$LEVELDB_ROOT ; $(MAKE) clean
